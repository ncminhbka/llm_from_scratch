...
class GPTModern(nn.Module):
    def __init__(self, vocab_size: int = 256, block_size: int = 256,
        ...
        self.tok_emb = nn.Embedding(vocab_size, n_embd) #chỉ cần embedding cho token, lúc này pos embedding nằm trong Decoder blocks
    ...
    def generate(self, 
        ...
        try:
            from part2.utils import top_k_top_p_filtering as _tk
        except Exception:
            _tk = lambda x, **_: x
